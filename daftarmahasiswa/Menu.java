...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2105899", "Azzahra Alika", "A", "Perempuan", "Ilmu Komputer"));
        listMhs.add(new Mahasiswa("21067855", "Lee Taeyong", "A", "Laki-Laki", "Ilmu Komputer"));
        listMhs.add(new Mahasiswa("2135677", "Lee Minhyung", "A", "Laki-Laki", "Sastra Inggris"));
        
        // Set Table
        tblMhs.setModel(setTable());
        
        // Hide Delete button
        //kalo true dia bakal muncul si buttonnya
    ...
    public void insertData() {
        ...
        // Add New Data
        listMhs.add(new Mahasiswa(nim, nama, nilai, kelamin, prodi));
    ...
    private void initComponents() {
        ...
        lblNim.setFont(new java.awt.Font("Myanmar Text", 0, 14)); // NOI18N
        lblNim.setForeground(new java.awt.Color(255, 255, 255));
        lblNim.setText("NIM");

        lblNama.setFont(new java.awt.Font("Myanmar Text", 0, 14)); // NOI18N
        ...
        lblNilai.setFont(new java.awt.Font("Myanmar Text", 0, 14)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(isUpdate == false){
            ...
            updateData();
            //btnAdd, btnDelete itu nama variabel si buttton yang ada di navigator
            btnAdd.setText("Add");
            btnDelete.setVisible(false);
            this.isUpdate = false;
        }
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        String selectedProdi = (tblMhs.getModel().getValueAt(row, 3).toString());
        String selectedKelamin = (tblMhs.getModel().getValueAt(row, 4).toString());
        ...
        jComboBox1.setSelectedItem(selectedKelamin);
        fieldProdi.setText(selectedProdi);
        
        btnAdd.setText("Update");
        //di set true biar button deletenya gaada
